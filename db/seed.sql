-- ============================================================
--  FloresOnline — Datos iniciales (seed)
--  Idempotente: usa ON CONFLICT para poder re-ejecutar.
-- ============================================================

-- ---------- Empleado demo (login del CRM) ----------
INSERT INTO employees (name, email, pass_hash, role) VALUES
  ('Ana Gómez', 'ana@floresonline.com', crypt('demo1234', gen_salt('bf')), 'Vendedora')
ON CONFLICT (email) DO NOTHING;

-- ---------- Repartidores ----------
INSERT INTO couriers (name) VALUES
  ('Sin asignar'), ('Luis Rodríguez'), ('Pedro Gutiérrez'), ('Carla Méndez')
