...
export function EntregasPage() {
  ...
  return (
    <div className="h-full overflow-y-auto px-7 pb-10 pt-6">
      ...
      {activas.length === 0 ? (
        <div className="mt-6 flex flex-col items-center rounded-[18px] border border-line bg-surface py-16 text-center shadow-soft">
          <Truck size={40} className="text-faint" />
          <h3 className="mt-3 text-[22px] font-semibold text-ink">Sin entregas activas</h3>
